...
*/
	...
	function qb(a) {
		...
		if (
			...
			d & 128 &&
				((d = b[c++]),
				(e |= (d & 127) << 14),
				d & 128 && ((d = b[c++]), (e |= (d & 127) << 21), d & 128 && ((d = b[c++]), (e |= d << 28), d & 128 && b[c++] & 128 && b[c++] & 128 && b[c++] & 128 && b[c++] & 128 && b[c++] & 128))))
		)
			throw Za()
		pb(a, c)
		return e
		...
		if (g)
			throw Error(
				"Message parsing ended unexpectedly. Expected to read " +
					(e + " bytes, instead read " + (e - g) + " bytes, either the data ended unexpectedly or the message misreported its own length")
			)
		a.h.h = f
		a.h.j = d
	}
	...
	function Q(a, b) {
		N ? (a[N] = b) : void 0 !== a.B ? (a.B = b) : Object.defineProperties(a, { B: { value: b, configurable: !0, writable: !0, enumerable: !1 } })
	}
	function Lb(a) {
		O(a, 1)
		return a
						...
						((l = a[h++]),
							128 > l
								...
								: 224 > l
									? h >= d
										? ab()
										: ((m = a[h++]), 194 > l || 128 !== (m & 192) ? (h--, ab()) : e.push(((l & 31) << 6) | (m & 63)))
									: 240 > l
										? h >= d - 1
											? ab()
											: ((m = a[h++]),
												128 !== (m & 192) || (224 === l && 160 > m) || (237 === l && 160 <= m) || 128 !== ((f = a[h++]) & 192)
													? (h--, ab())
										...
										: 244 >= l
											? h >= d - 2
												? ab()
												: ((m = a[h++]),
													128 !== (m & 192) || 0 !== ((l << 28) + (m - 144)) >> 30 || 128 !== ((f = a[h++]) & 192) || 128 !== ((g = a[h++]) & 192)
														? (h--, ab())
														: ((l = ((l & 7) << 18) | ((m & 63) << 12) | ((f & 63) << 6) | (g & 63)), (l -= 65536), e.push(((l >> 10) & 1023) + 55296, (l & 1023) + 56320)))
											: ab(),
		...
		return D(function (p) {
			switch (p.h) {
				...
				case 6:
					...
					a.i.canvas = a.m
					f = a.i.GL.createContext(a.m, { antialias: !1, alpha: !1, ua: "undefined" !== typeof WebGL2RenderingContext ? 2 : 1 })
			...
			for (var d = [], e = [], f = {}, g = A(Object.keys(a)), h = g.next(); !h.done; f = { X: f.X, Y: f.Y }, h = g.next())
				if (((h = h.value), !(h in this.l && this.l[h] === a[h]))) {
					...
					void 0 !== k &&
						...
						k.graphOptionXref &&
							((h = Object.assign({}, { calculatorName: "", calculatorIndex: 0 }, k.graphOptionXref, {
	...
	function fe(a) {
		...
		this.h = new Rd({
			...
			files: [{ url: "holistic_solution_packed_assets_loader.js" }, { simd: !1, url: "holistic_solution_wasm_bin.js" }, { simd: !0, url: "holistic_solution_simd_wasm_bin.js" }],
			...
			options: {
				...
				enableSegmentation: {
					type: 0,
					graphOptionXref: { calculatorType: "ConstantSidePacketCalculator", calculatorName: "ConstantSidePacketCalculatorEnableSegmentation", fieldName: "bool_value" },
				},
				smoothSegmentation: {
					type: 0,
				...
				refineFaceLandmarks: {
					type: 0,
					graphOptionXref: { calculatorType: "ConstantSidePacketCalculator", calculatorName: "ConstantSidePacketCalculatorRefineFaceLandmarks", fieldName: "bool_value" },
				},
